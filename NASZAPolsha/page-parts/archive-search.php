...
if (false) {
    ...
    <div class="widget widget_search" style="margin-bottom: 20px;">
        <form role="search" method="get" class="searchform" action="https://dev.nashapolsha.pl/">
            <div class="input-group">
                <input name="s" autocomplete="off" type="text" class="ajax_s form-control input-sm" value="" style="opacity: 1;" placeholder="Search">
    ...
    echo '<div class="search_form_archive">' . do_shortcode('[kleo_search_form context="' . $post_types . '" placeholder="Search"]') . '</div>';
}
?>