...
$reklama_menu = wp_nav_menu(array(
    'theme_location' => 'reklama_menu',
    'depth' => 1,
    'container' => 'div',
    'container_class' => 'primary-menu reklama_menu collapse navbar-collapse nav-collapse',
    'menu_class' => 'nav navbar-nav',
    //'fallback_cb'       => 'kleo_walker_nav_menu::fallback',		
    'fallback_cb' => '',
    'walker' => new kleo_walker_nav_menu(),
...
$primary_menu_pl = wp_nav_menu(array(
    'theme_location' => 'pl_menu',
    'depth' => 1,
    'container' => 'div',
    'container_class' => 'primary-menu collapse navbar-collapse nav-collapse',
    'menu_class' => 'nav navbar-nav',
...
$is_pl_page = get_post_meta(get_the_ID(), 'is_pl_page', true);
?>
            ...
            <div class="container">
                ...
                <?php if ($header_style == 'left_logo') : ?>
                    <div class="header-banner">
                        ...
                        $pl_active = '';
                        $ua_active = '';
                        if (!empty($is_pl_page) && $is_pl_page != 0) {
                            $pl_active = 'active';
                        } else {
                            $ua_active = 'active';
                        }
                        echo '<div id="pl_menu_lang"><a href="https://dev.nashapolsha.pl/pl/" class="' . $pl_active . '">PL</a> / <a href="https://dev.nashapolsha.pl/" class="' . $ua_active . '">UA</a></div>';
