 ...
 */
get_header();
if ( is_active_sidebar( 'archive-top-sidebar' ) ) { dynamic_sidebar( 'archive-top-sidebar' );}
?>
...
<?php get_template_part('page-parts/archive-search'); ?>
<?php get_template_part('page-parts/archive-classifieds-top'); ?>
<?php //dynamic_sidebar('home-classifieds'); ?>
