 ...
 */
?>
<style>.bp-login-widget-register-link {display: none}</style>
<div id="buddypress">
    ...
    <div class="page row" id="register-page">
        <div class="col-sm-6"><?php dynamic_sidebar('sidebar-buddypress'); ?></div>
        <form action="" name="signup_form" id="signup_form" class="standard-form col-sm-6" method="post" enctype="multipart/form-data">
