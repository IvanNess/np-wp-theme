...
//        if ($post_media_enabled) {
        if (!empty($slides)) {
            ...
            if (true) {
                ...
                echo '<div class="kleo-banner-items modal-gallery"></div><div id="slider" class="flexslider loading"><ul class="slides">';
                foreach ($slides as $slide) {
                    if ($slide) {
                        ...
                        echo '<li><a href="' . $slide . '" data-rel="modalPhoto[inner-gallery]"><img src="' . $image . '" /></a></li>';
                    }
                }
                echo '</ul></div>';
                echo '<div id="carousel" class="flexslider loading"><ul class="slides">';
                foreach ($slides as $slide) {
                    if ($slide) {
                        $image = aq_resize($slide, $slide_width, $slide_height, true, true, true);
                        //small hack for non-hosted images
                ...
                foreach ($slides as $slide) {
                    if ($slide) {
                        ...
                        $flexslider_slider .= '<li><img src="' . $image . '"></li>';
                        $flexslider_carousel .= '<li><img src="' . $image . '"></li>';
                        if ($cur_user_id == 1) {
